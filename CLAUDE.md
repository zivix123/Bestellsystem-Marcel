...
```
n8n URL:        https://beginner-specialists-mac-helmet.trycloudflare.com
...
```bash
docker run -e N8N_BASE_URL=https://beginner-specialists-mac-helmet.trycloudflare.com ...
```
...
bereit, über die andere Workflows per HTTP Request (`https://beginner-specialists-mac-helmet.trycloudflare.com/webhook/...`)
...
```javascript
const N8N_BASE_URL = 'https://beginner-specialists-mac-helmet.trycloudflare.com';
```
...
```json
{
  "mcpServers": {
    "n8n": {
      ...
      "env": {
        "N8N_HOST": "https://beginner-specialists-mac-helmet.trycloudflare.com",
